...
# Call the function
mean_centre_plt_NA_median = mean_centre(plt_NA_median[,2:19])
...
standard_z_plt_NA_median = standard_z(plt_NA_median[,2:19])
standard_z_plt_NA_median
standard_z_plt_NA_mean = standard_z(plt_NA_mean[,2:19])
...
# Call the function
normal_min_max_NA_median =normal_min_max(plt_NA_median[,2:19])
normal_min_max_NA_median
normal_min_max_NA_mean = normal_min_max(plt_NA_mean[,2:19])
...
unique_plt = subset(plt, select = -Leaf.weight)
